...
const columns: ColumnDef<RekognisiData>[] = [
...
const dataRekognisi: RekognisiData[] = [
...
export default function RekognisiPage() {
  const table = useReactTable({
    data: dataRekognisi, columns, getCoreRowModel: getCoreRowModel(), getPaginationRowModel: getPaginationRowModel(),
  });
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <header className="px-4 sm:px-8 py-4 sm:py-6 flex justify-between items-center bg-white border-b border-slate-100 sticky top-0 z-20">
              <div>
                <h2 className="text-xl sm:text-2xl font-bold text-slate-900 tracking-tight">Rekognisi</h2>
                {/* Sapaan menyesuaikan ukuran layar */}
                <p className="text-slate-500 text-xs sm:text-sm font-medium">Kelola data rekognisi mahasiswa</p>
              </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 md:gap-4">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 md:gap-3 flex-1 w-full">
            <div className="relative w-full sm:w-auto sm:max-w-sm">
              ...
              <Input placeholder="Cari rekognisi..." className="pl-10 h-10 bg-white border-slate-200 rounded-lg text-sm w-full" />
            </div>
          ...
          <Link href="/rekognisi/tambah" className="w-full sm:w-auto">
