  ...
  return (
    <RoleGuard allowedRoles={["mahasiswa"]}>
      <form className='flex flex-col gap-6 animate-in fade-in duration-500 max-w-5xl w-full mx-auto p-4 md:p-0'>
        <FormPageHeader
          title='Rekognisi'
          description='Lengkapi data rekognisi, mahasiswa, dan dosen pendamping dalam satu alur.'
          breadcrumbs={[
            { label: "Dashboard" },
            { label: "Rekognisi" },
        ...
        <FormWelcomeBanner
          ...
          description='Data mahasiswa dan dosen kini diisi langsung di form ini, sehingga tidak perlu berpindah halaman setelah data rekognisi tersimpan.'
        />
